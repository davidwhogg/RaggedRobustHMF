...
\title{\bfseries Ragged, robust, heteroskedastic matrix factorization}
...
\begin{align}
    y_{nj} &= \sum_{k=1}^K a_{nk} \sum_{m=-M}^M b_{k,m}\,\exp(\ii m\,\frac{2\pi\,\lambda_{nj}}{L}) + \text{residual}_{nj} ~,
\end{align}
